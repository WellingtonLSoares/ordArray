...
Esta função
1 : se x for menor que y.
0 : se x for equivalente a y.
-1: se x for maior que y na ordem.
...
ordem crescente, ou seja: x[i] for menor que ou equivalente a x[j] para todo i < j.
